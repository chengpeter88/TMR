...
# %%
# 點開更多評論
review_click= browser.find_elements(By.CLASS_NAME,"wNNZR.???")[2]
actions=ActionChains(browser)
actions.move_to_element(review_click).???
review_click.???

# %%
# 開啟評論選單
menu_click = browser.find_elements(By.CLASS_NAME,'g88MCb.S9kvJb')[???]
