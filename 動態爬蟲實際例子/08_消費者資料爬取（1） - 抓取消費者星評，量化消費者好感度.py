...
#<div class="F7nice " jslog="76333;mutable:true;"><span><span aria-hidden="true">4.5</span><span class="ceNzKf" role="img" aria-label="4.5 星級 "><span class="rFrJzc"></span><span class="rFrJzc"></span><span class="rFrJzc"></span><span class="rFrJzc"></span><span class="rFrJzc UpDOYb"></span></span></span><span><span><span aria-label="1,705 則評論">(1,705)</span></span></span></div>
...
#爬取星級
star_section=[]
star_section.append(???(soup.find_all(class_="F7nice")[0].???))
print("學校星級：", star_section)

#建立df
school=???({"學校名稱":???,"學校星級":star_section})
school
